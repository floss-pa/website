class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:user_id, :title, :image, :location, :frecuency, :start_at_date, :start_at_time, :end_at_date,:end_at_time, :description, :keyworkds, :ticket_url, :community_id, :organizer, :publish, tickets_attributes: [:id, :event_id, :ticket_type_id, :amount, :token])
    end
end
