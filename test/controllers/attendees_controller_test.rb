...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { ticket_id: @attendee.ticket_id, user_id: @attendee.user_id } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { ticket_id: @attendee.ticket_id, user_id: @attendee.user_id } }
